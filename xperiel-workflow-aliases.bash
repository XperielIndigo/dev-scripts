...
alias run-ios-wrapper='bazel run //src/main/objc/com/xperiel/newapi:TestNewApi --fetch=false'
alias build-cc='bazel build //src/main/cc/... --fetch=false'
alias build-objc='bazel build //src/main/objc/... --fetch=false'
alias build-ios-wrapper='bazel build //src/main/objc/com/xperiel/newapi:all --fetch=false'
